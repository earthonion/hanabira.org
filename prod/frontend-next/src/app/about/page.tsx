...
export default function About() {
    ...
    <div className="grid lg:grid-cols-body p-5">
      <div className="lg:col-span-10">
        ...
        <div className="mt-2 text-gray-500">
          Hanabira is Free Japanese language learning website that aims to
          prepare students for JLPT N5-N1. Enjoy studying Japanese without ads
          and popups. Currently we are offering Grammar explanation for all JLPT
          levels. Additionally we have several JLPT vocabulary related sections.
          All lessons contain audio voiceovers for vocabulary, grammar and
          example sentences. Other features will be imlemented in the future.
          Please see roadmap below.
        </div>
        ...
        <div className="p-4 md:p-6 bg-white dark:bg-gray-800">
          ...
          <p className="mt-2 text-gray-700 dark:text-gray-300">
            Currently all content is free. And all content will be free for long time.
          </p>
          <p className="mt-2 text-gray-700 dark:text-gray-300">
            It is possible that in the future certain features will be paid to
            keep servers running. But even in such case lots of features will
  ...
  <div class="p-6 bg-white shadow-xl rounded-lg border border-gray-200">
    <h2 class="font-semibold text-2xl mb-5 border-b pb-2 border-gray-300">
      Web Sources:
    </h2>

    <h3 class="font-semibold text-xl mb-5 border-b pb-2 border-gray-300">
      Japanese:
    </h3>

    <p>
      <strong>JLPT level vocabulary lists</strong> taken from 
      <a href="https://www.tanos.co.uk/jlpt/" class="text-blue-600 hover:text-blue-800 visited:text-purple-600" target="_blank" rel="noopener noreferrer">Tanos.co.uk</a>
    </p>

    <p class="mt-2">
      (eventually we will also use Kanji JLPT lists) licence: Creative Commons "BY" - 
      <a href="https://www.tanos.co.uk/jlpt/sharing/" class="text-blue-600 hover:text-blue-800 visited:text-purple-600" target="_blank" rel="noopener noreferrer">License Details</a>
    </p>
