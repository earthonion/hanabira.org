...
//         {data.map((word, index) => (
//           <tr key={index}>
//             <td>{word.vocabulary_japanese}</td>
//             <td>{word.vocabulary_simplified}</td>
//             <td>{word.vocabulary_english}</td>
//             <td>
//               <audio controls>
...
//                   <p>{sentence.sentence_english}</p>
//                 </div>
//               ))}
//             </td>
//             <td>
//               <button onClick={() => deleteWord(word.vocabulary_japanese)}>
//                 Delete
//               </button>
//             </td>
//           </tr>
