            ...
            <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
              <div className="mx-auto max-w-xl px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:px-0 lg:py-32">
                <div>
                  ...
                  <div className="mt-6">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900">
                      Grammar Graph Analyzer + Downloadable content - grammar + vocabulary
                    </h2>
                    <p className="mt-4 text-lg text-gray-500">
                      Prototype of Grammar Graph Analyzer. Shows useful grammar structure in visual manner. Great for visual learners.
